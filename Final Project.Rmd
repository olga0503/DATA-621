...
boxplot(data$Servived)

par(mfrow=c(1,2))
plotNormalHistogram(data$Servived,main="Survived")
qqnorm(data$Servived)
qqline(data$Servived)
...
par(mfrow=c(1,2))
plotNormalHistogram(data$Pclass,main="Survived")
qqnorm(data$Pclass)
qqline(data$Pclass)
...
par(mfrow=c(1,2))
plotNormalHistogram(data$Pclass,main="Sex")
qqnorm(data$Sex)
qqline(data$Sex)
...
par(mfrow=c(1,2))
plotNormalHistogram(data$Ticket,main="Ticket")
qqnorm(data$Ticket)
qqline(data$Ticket)
...
boxplot(data$Embarked)

par(mfrow=c(1,2))
plotNormalHistogram(data$Fare,main="Embarked")
qqnorm(data$Embarked)
qqline(data$Embarked)

```
=======

>>>>>>> 87fe469aca4cd8056ed52f77527d0a0d983c75df
...
data <- data %>% mutate(Age = Age^power_Age,Fare = Fare^power_Fare,Sibsp=Sibsp^power_Sibsp,Parch=PAtch^power_Parch,Floor=Floor^power_Floor)
=======
